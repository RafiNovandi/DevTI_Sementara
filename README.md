...
4. Set environment variables in `.env` (API URL, etc.):

### Database Setup (TRPC Example)

If you want to run the local database to see the **TRPC example implementation on the Table Page**, follow these steps:
